                        ...
                        <div class="menu-list">
                            <div class="menu-item">
                                ...
                                <a href="{{ route('Dashboard') }}"
                                    style="color:inherit; text-decoration:none;">Dashboards</a>
                            </div>
                            <div class="menu-item">
                ...
                <div class="main-content1">
                    <div class="registration-container">
                        <div class="form-header">
                            ...
                            <p class="form-subtitle">Completa todos los campos para registrar un nuevo refugio en
                                PanitasPet</p>
                        </div>
                        ...
                        @if ($errors->any())
                            <div class="alert alert-danger"
                                style="color: red; background-color: #f8d7da; border-color: #f5c6cb; padding: 10px; margin-bottom: 20px; border-radius: 5px;">
                                <ul>
                        ...
                        <form class="form-fields" id="refugeRegistrationForm" method="POST"
                            ...
                            <div class="form-row">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nombre_refugio" class="form-input"
                                        placeholder="Ej: Refugio Amor Animal" required>
                                </div>
                                <div class="form-group">
                                    <label class="form-label">Responsable *</label>
                                    <input type="text" name="responsable_nombre" class="form-input"
                            ...
                            <div class="form-row">
                                <div class="form-group">
                                    ...
                                    <input type="tel" name="telefono_refugio" class="form-input"
                                        placeholder="Ej: +584141234567" required>
                                </div>
                                <div class="form-group">
                                    <label class="form-label">Cédula de identidad *</label>
                                    <input type="text" name="cedula_responsable" class="form-input"
                                        placeholder="Ej: V-30.000.000" required>
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="form-group">
                                    ...
                                    <input type="email" name="email_refugio" class="form-input"
                                        placeholder="ejemplo@correo.com" required>
                                </div>
                                <div class="form-group">
                                    <label class="form-label">Contraseña *</label>
                                    <input type="password" name="password_refugio" class="form-input"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="direccion_refugio" class="form-input"
                                    placeholder="Calle, número, ciudad, estado etc" required>
                            </div>

                            <div class="form-group">
                                <label class="form-label">Redes sociales (si hay) *</label>
                                <input type="text" name="redes_sociales" class="form-input"
                                    placeholder="Ej: @refugio_amor_animal" required>
                            </div>
                            <div class="form-group">
                                <label class="form-label">Fecha de Fundación</label>
                                <div class="date-row" style="display:flex;gap:12px;align-items:center;">
                                    <input type="number" name="foundation_day" class="form-input" placeholder="DD"
                                        min="1" max="31" style="width:84px;">
                                    <input type="number" name="foundation_month" class="form-input"
                                        placeholder="MM" min="1" max="12" style="width:84px;">
                                    <input type="number" name="foundation_year" class="form-input"
                                        placeholder="YYYY" min="1800" max="2100" style="width:120px;">
                                </div>
                            </div>

                            <div class="form-group">
                                <label class="form-label">Descripción del Refugio</label>
                                <textarea name="descripcion_refugio" class="form-input"
                                    placeholder="Describe brevemente la misión, servicios y características del refugio..."></textarea>
