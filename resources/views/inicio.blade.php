        ...
        <div class="content-wrapper">
            ...
            <section class="hero-section">
                <div class="hero-text">
                    ...
                    <p>En nuestra página web podrás adoptar, dar en adopción y si eres un refugio también podrás
                        asociarte con nosotros.</p>
                </div>
            ...
            <section class="pets-section">
                ...
                <div class="pets-container">
                    ...
                    <div class="pets-footer">
                        ...
                        @if (auth()->user())
                            <a href="{{ route('vistavacia') }}" class="public-all-btn">Publicar mascota</a>
                        @endif
                ...
                <div class="process-container">
                    <div class="process-header">
                        <div class="process-text-container">
                            ...
                            <p class="process-subtitle">Adoptar es un gran paso. Hemos diseñado un proceso claro y
                                positivo tanto para ti como para tu futura mascota.</p>
                        </div>
                    </div>
                    ...
                    <div class="process-steps">
                        <article class="process-step">
                            ...
                            <p class="step-description">Navega por los perfiles de nuestras mascotas. Usa los filtros
                                para encontrar a tu panita ideal según su especie, tamaño, edad o ubicación.</p>
                        </article>
                        ...
                        <article class="process-step">
                            ...
                            <p class="step-description">¿Encontraste a tu compañero? Completa el formulario online para
                                nuestros refugios o envía un mensaje directo para los usuarios como tú para asegurar el
                                bienestar animal</p>
                        </article>
                        ...
                        <article class="process-step">
                            ...
                            <p class="step-description">La organización revisará tu formulario cuidadosamente y te
                                contactará con la decisión. También puedes conversar directamente con los dueños
                                actuales y aclarar dudas sobre el carácter.</p>
                        </article>
                        ...
                        <article class="process-step">
                            ...
                            <p class="step-description">Una vez aprobada la solicitud o finalizada la charla, se
                                coordinan los últimos detalles: posible encuentro físico, acuerdo final y bienvenida a
                                tu nuevo panita.</p>
                        </article>
                    </div>
                </div>
                ...
                <div class="home-container">
                    <div class="home-three-columns">
                        ...
                        <div class="home-text-box">
                            ...
                            <p class="home-description">Hasta la fecha, cientos de "panas" han conseguido encontrar una
                                familia gracias a la conexión directa en nuestra plataforma. Ya sea que un usuario deba
                                entregar a su mascota por motivos de fuerza mayor o que un refugio busque espacio para
                                un rescatado, nuestra misión es que ningún animal termine en la calle.</p>
                        </div>

                        <!-- Columna 2: Primera imagen -->
                        <div class="home-image-box">
                            <img src="images/gatogris.jpg" alt="Gatito blanco y gris con juguete de ratón verde"
                                class="home-image">
                        ...
                        <div class="home-image-box">
                            <img src="images/gatonaran.jpg" alt="Gato naranja con juguete en espiral"
                                class="home-image">
                            <div>
                            </div>
                        </div>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const counterData = [{
                element: '.stat-card:nth-child(1) .stat-number',
                final: 200,
                suffix: '+'
            },
            {
                element: '.stat-card:nth-child(2) .stat-number',
                final: 10,
                suffix: '+'
            },
            {
                element: '.stat-card:nth-child(3) .stat-number',
                final: 500,
                suffix: '+'
            },
            {
                element: '.stat-card:nth-child(4) .stat-number',
                final: 440,
                suffix: '+'
            }
        ];
                    ...
                    if (entry.isIntersecting) {
                        ...
                        counterData.forEach((counter, index) => {
                            ...
                            if (element) {
                                ...
                                setTimeout(() => {
                                    animateCounter(element, counter.final,
                                        counter.suffix);
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const sections = document.querySelectorAll(
            '.pets-section, .impact-section, .process-section, .home-section, .mission-vision-section');
