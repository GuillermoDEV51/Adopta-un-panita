    ...
    <div class="publicar-wrapper">
        <div class="publicar-content">
            ...
            <div class="publicar-left">
                ...
                @if (session('success'))
                    <div class="alert alert-success" style="background:#e5ffe5; color:#006600; padding:12px; border-radius:8px; margin-bottom:16px;">
                        {{ session('success') }}
                    </div>
                @endif
                ...
                <form id="publicarForm" method="POST" action="{{ route('publicar2') }}" enctype="multipart/form-data">
                    ...
                    <div class="form-grid">
                        ...
                        <div class="photo-column">
                            <label style="color:#af7700; font-weight: 600; display: block; margin-bottom: 8px;">Foto de la mascota</label>
                            <input type="file" id="fotoMascota" name="foto" accept="image/*" hidden>
                            <label for="fotoMascota" class="photo-box" style="display: block; width: 100%; height: 300px; border: 2px dashed #af7700; border-radius: 8px; cursor: pointer; overflow: hidden; position: relative; background: #f9f9f9;">
                                <div style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); text-align: center;">
                                    <span style="color:#af7700; font-size: 16px;">📷 Añadir foto</span>
                                </div>
                                <img id="previewFoto" alt="" style="width: 100%; height: 100%; object-fit: cover; display: none;" />
                            </label>
                            @error('foto')
                        ...
                        <div class="fields-column">
                            ...
                            <div class="form-row" style="display: flex; gap: 20px; margin-bottom: 20px;">
                                <div class="form-group" style="flex: 1;">
                                    <label style="color:#af7700; font-weight: 600; display: block; margin-bottom: 8px;">Nombre</label>
                                ...
                                <div class="form-group" style="flex: 1;">
                                    <label style="color:#af7700; font-weight: 600; display: block; margin-bottom: 8px;">Especie</label>
                            ...
                            <div class="form-row" style="display: flex; gap: 20px; margin-bottom: 20px;">
                                <div class="form-group" style="flex: 1;">
                                    <label style="color:#af7700; font-weight: 600; display: block; margin-bottom: 8px;">Edad (años)</label>
                                ...
                                <div class="form-group" style="flex: 1;">
                                    <label style="color:#af7700; font-weight: 600; display: block; margin-bottom: 8px;">Peso (LB)</label>
                            ...
                            <div class="form-row" style="display: flex; gap: 20px; margin-bottom: 20px;">
                                <div class="form-group" style="flex: 1;">
                                    <label style="color:#af7700; font-weight: 600; display: block; margin-bottom: 8px;">Tamaño</label>
                                ...
                                <div class="form-group" style="flex: 1;">
                                    <label style="color:#af7700; font-weight: 600; display: block; margin-bottom: 8px;">Sexo</label>
                    ...
                    <div class="description-full-width" style="margin-top: 30px;">
                        <label style="color:#af7700; font-weight: 600; display: block; margin-bottom: 8px;">Descripción</label>
                        <textarea id="descripcion" rows="6" maxlength="500" 
                                  name="descripcion" placeholder="Describe al panita"
                    ...
                    <div class="form-row" style="display: flex; gap: 20px; margin-top: 20px;">
                        <div class="form-group" style="flex: 1;">
                            <label style="color:#af7700; font-weight: 600; display: block; margin-bottom: 8px;">Raza</label>
                    ...
                    <div class="form-row" style="display: flex; gap: 20px; margin-top: 20px;">
                        <div class="form-group" style="flex: 1;">
                            <label style="color:#af7700; font-weight: 600; display: block; margin-bottom: 8px;">Ubicación</label>
                    ...
                    <div class="form-row" style="display: flex; gap: 20px; margin-top: 20px;">
                        <div class="form-group" style="flex: 1;">
                            <label style="color:#af7700; font-weight: 600; display: block; margin-bottom: 8px;">Vacunado</label>
                        ...
                        <div class="form-group" style="flex: 1;">
                            <label style="color:#af7700; font-weight: 600; display: block; margin-bottom: 8px;">Esterilizado</label>
            ...
            <div class="publicar-right">
                <img id="publicarImage" 
                     src="{{ asset('images/fotomodal1.png') }}" 
                     alt="Imagen mascota" class="right-image-img"
