        ...
        <form class="modal-form" id="publicarForm" method="POST" enctype="multipart/form-data">
                    ...
                    <div>
                        ...
                        <div class="form-row" style="margin-top:8px;">
                            <div class="form-group" style="flex:0 0 140px;">
                                ...
                                <input type="number" name="edad" id="edad" min="0" max="30"
                                    placeholder="Años" required>
                            </div>

                            <div class="form-group" style="flex:0 0 140px;">
                                <label for="peso" style="color:#af7700">Peso (LB)</label>
                                <input type="number" name="peso" id="peso" min="0" max="100"
            ...
            <div class="form-row">
                <div class="form-group full-width">
                    ...
                    <textarea id="descripcion" name="descripcion" rows="5" placeholder="Descripción de la mascota" required
            ...
            <div class="form-row">
                <div style="flex:1; display:flex; flex-direction:column; gap:14px;">
                    <div class="form-group">
                        ...
                        <input type="file" id="historial" class="file-input-hidden" name="documentacion" multiple
                    ...
                    <div>
                        ...
                        <div class="form-row" style="margin-top:8px;">
                            <div class="form-group" style="flex:0 0 300px;">
                                <label for="otros_animales" style="color:#af7700">¿Se lleva bien con otros
                                    animales?</label>
