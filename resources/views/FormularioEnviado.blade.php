...
<head>
  ...
  <title>Formulario Enviado - PanitasPet | Adopción y Refugios de Mascotas</title>
        ...
        <section>
          <div class="dollar-box animate-on-scroll animate-right">
            <div class="dollar-row">
                <img src="../assets/images/perroygato.png" alt="dog" class="dollar-image1"> 
        ...
        <section>
         <div class="dollar-box animate-on-scroll animate-right">
            ...
            <p>Mantener activa la visibilidad aumentada para todos los animales.</p>
              ...
              <img src="../assets/images/perritoconmancha.png" alt="dog" class="any-decor1"> 
          </div>
        </section>
