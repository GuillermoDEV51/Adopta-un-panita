...
@vite (['resources/css/modal-publicar.css', 'resources/js/modal-publicar.js'])
                ...
                <div class="modal-left">
                    ...
                    <form class="modal-form" id="publicarForm">
                        <div class="form-row">
                            <div style="flex:1; display:flex; flex-direction:column; gap:14px;">
                                <div class="form-group">
                                    <label for="nombre" style="color:#af7700">Historial médico</label>
                                    <input type="file" id="nombre" class="file-input-hidden" name="historialFiles" multiple accept=".pdf,.jpg,.jpeg,.png,.doc,.docx" />
                                    <label for="nombre" class="file-input-label" title="Añadir archivos">
                                        <span class="sr-only">Añadir archivos</span>
                                ...
                                <div>
                                    <div class="form-group">
                                        <label for="especie" style="color:#af7700">Raza</label>
                                    ...
                                    <div class="form-row" style="margin-top:8px;">
                                        <div class="form-group" style="flex:0 0 300px;">
                                            <label for="edad" style="color:#af7700">¿Se lleva bien con otros animales?</label>
                                            <select id="Si/No" required>
                                        ...
                                        <div class="form-group" style="flex:0 0 300px;">
                                            <label for="lb" style="color:#af7700">¿Se lleva bien con personas?</label>
                                            <select id="Si/No" required>
                                            <option value="" disabled selected>Si/No</option>                                                
                                                <option value="Si">Si</option>
                                                <option value="No">No</option>
                        ...
                        <div class="form-row">                                 
                                    ...
                                    <label for="nombre" style="color:#af7700">Ubicación del responsable</label>
                                            <select id="Si/No" required>
                                    ...
                                    <div class="form-row" style="margin-top:8px;">
                                        <div class="form-group" style="flex:0 0 300px;">
                                            <label for="edad" style="color:#af7700">¿Está vacunado el panita?</label>
                                            <select id="Si/No" required>
                                            <option value="" disabled selected>Si/No</option>                                                
                                                <option value="Si">Si</option>
                                                <option value="No">No</option>
                                        ...
                                        <div class="form-group" style="flex:0 0 300px;">
                                            <label for="lb" style="color:#af7700">¿Está esterilizado el panita?</label>
                                            <select id="Si/No" required>
                                            <option value="" disabled selected>Si/No</option>                                                
                                                <option value="Si">Si</option>
                                                <option value="No">No</option>
                        ...
                        <div style="display:flex; justify-content:center; margin:36px 0 8px 0;">
                            <button type="submit" class="submit-btn">Regresar</button>
                        <div style="display:flex; justify-content:center; margin:36px 0 8px 30px;"></div>
