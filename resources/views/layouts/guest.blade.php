  ...
  <main class="main-container">
    ...
    @else
      ...
      <div class="background-images">
        <img src="{{ asset('images/img_pink_and_yellow_228x174.png') }}" class= "w-5 h-auto" alt="Decorative paw prints" class="bg-image-left">
        <img src="{{ asset('images/img_pink_and_yellow.png') }}" alt="Decorative paw prints" class="bg-image-right">
      </div>
    @endif
